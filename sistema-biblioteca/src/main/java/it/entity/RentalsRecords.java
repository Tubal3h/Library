...
public class RentalsRecords {
     ...
     */
    public RentalsRecords(int rental_id, int user_id, int book_id, String book_name, String author_full_name, String publisher_name, LocalDate publication_date, String category_name, String isbn_code, LocalDate rental_date, LocalDate rental_expired, LocalDate rental_ended) {
